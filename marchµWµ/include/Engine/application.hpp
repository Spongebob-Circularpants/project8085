...
namespace Engine
{
	struct applicationData
	{
		...
		std::unique_ptr<microcontroller::components> m_muController;
		...
		applicationData() : 
			...
			m_muController(std::make_unique<microcontroller::components>())
		{
		}
	...
	public:
		...
		unsigned independentAccess(unsigned address);
	private:
